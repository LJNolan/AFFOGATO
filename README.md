...
Used in [Nolan et al., 2025](https://iopscience.iop.org/article/10.3847/1538-4357/adec95) and submitted separately to JOSS. [The example file](example.ipynb) should work in an environment installed with `Jupyter` and `affogato-agn` installed - I use Conda, and add conda-nb-kernels to the environment setup and install `AFFOGATO` separately with `pip`.
